...
exports.handler = async (event) => {
  ...
  return {
    statusCode: 200,
    headers: corsHeaders(),
    body: JSON.stringify({ message: "Hello with CORS 🚀" }),
  };
};

function corsHeaders() {
  return {
    "Access-Control-Allow-Origin": "https://giovannis-marvelous-site-238521.webflow.io", // 👈 replace with your site
